        ...
        <div class="col-12">
            ...
            <div class="details-container">
                ...
                <div class="detail-group text-center mt-4">
                    <a href="{{ url('admin/institution-managements') }}" class="btn-back">
                        <i class="fas fa-arrow-left"></i>
                        Back to List
                    </a>
                    <a href="{{ url('admin/institution-managements/'.$institution->id.'/edit') }}" class="btn-back" style="background: #25836e; color: #fff; margin-left: 12px;">
