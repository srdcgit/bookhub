                ...
                <form method="post" action="{{ url('admin/blocks/'.$block->id) }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ old('name', $block->name) }}" placeholder="Enter block name" required>
                            @error('name')
                    ...
                    <div class="form-group">
                        <div class="checkbox-container">
                            <input type="checkbox" name="status" id="status" value="1" {{ old('status', $block->status) ? 'checked' : '' }}>
