    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="form-container">
                <form method="post" action="{{ url('sales/students/'.$student->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="tel" name="phone" class="form-control" value="{{ old('phone', $student->phone) }}" placeholder="Enter 10-digit phone number" required>
                            @error('phone')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="class" class="form-control" value="{{ old('class', $student->class) }}" placeholder="Enter class/grade" required>
                            @error('class')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="roll_number" class="form-control" value="{{ old('roll_number', $student->roll_number) }}" placeholder="Enter roll number" required>
                            @error('roll_number')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
